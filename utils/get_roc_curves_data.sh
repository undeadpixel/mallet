...
../roc_curve.py ../files/hmms/tia1_binding_tgf/u1_comp_4tia1.tgf ../files/sequences/context_real_donors.raw > "$ROC_DATA/u1_comp_4tia1.tsv"
../roc_curve.py ../files/hmms/tia1_binding_tgf/small_prob_4TIA1.tgf ../files/sequences/context_real_donors.raw > "$ROC_DATA/small_prob_4TIA1.tsv"
