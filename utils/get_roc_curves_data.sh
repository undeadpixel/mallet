...
../scripts/roc_curve.py ../files/hmms/tia1_binding_tgf/small_prob_tia1.tgf ../files/sequences/context_real_donors.raw > "$ROC_DATA/small_prob_tia1.tsv"
../scripts/roc_curve.py ../files/hmms/tia1_binding_tgf/comp_prob_tia1.tgf ../files/sequences/context_real_donors.raw > "$ROC_DATA/comp_prob_tia1.tsv"
../scripts/roc_curve.py ../files/hmms/tia1_binding_tgf/comp_prob_4tia1.tgf ../files/sequences/context_real_donors.raw > "$ROC_DATA/comp_prob_4tia1.tsv"
